...
import io.github.maturapoj.tokenflow.domain.model.apply
import io.github.maturapoj.tokenflow.domain.model.hasContent
...
class ChatUseCase(
    ...
    private companion object {
        // Listed by /v1/models but can't do chat completions (embeddings, rerankers, and OpenAI's
        // speech, image and moderation models).
        val NON_CHAT = Regex("embed|rerank|whisper|tts|dall-e|moderation", RegexOption.IGNORE_CASE)
    }
}
