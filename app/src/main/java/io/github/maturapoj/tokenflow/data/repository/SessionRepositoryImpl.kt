...
import io.github.maturapoj.tokenflow.data.local.ChatDao
import io.github.maturapoj.tokenflow.data.local.MessageEntity
import io.github.maturapoj.tokenflow.data.local.SessionEntity
import io.github.maturapoj.tokenflow.data.local.StatsEntity
import io.github.maturapoj.tokenflow.data.remote.roleFromWire
...
private fun ChatError?.toColumns(): ErrorColumns = when (this) {
    ...
    ChatError.NotConfigured -> ErrorColumns("not_configured", null, null)
...
private fun errorFromColumns(kind: String?, code: Int?, detail: String?): ChatError? = when (kind) {
    "not_configured" -> ChatError.NotConfigured
